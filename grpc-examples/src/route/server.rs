...
use crate::proto_gen::route_guide::Feature;
use crate::proto_gen::route_guide::Point;
use crate::proto_gen::route_guide::Rectangle;
use crate::proto_gen::route_guide::RouteNote;
use crate::proto_gen::route_guide::RouteSummary;
use crate::proto_gen::route_guide_grpc::RouteGuide;
use crate::ROUTE_GUIDE_DB_PATH;
...
fn load_features(path: &Path) -> Vec<Feature> {
    //fs::read_dir("./grpc-examples/src/testdata").unwrap().into_iter().for_each(|path|println!("{}",path.unwrap().path().display()));
