...
openssl req -x509 -new -nodes -subj '/CN=www.mydom.com/O=My Company Name LTD./C=US' -key root-ca.key -sha256 -days 2048 -out root-ca.crt
...
openssl genrsa -out foobar.com.key 2048
...
openssl pkcs12 -export -inkey foobar.com.key -in foobar.com.crt -out foobar.com.p12 -password pass:mypassmypass
